...
local mappings = {
	...
	-- markdown-preview
	{ "n", "<space>m", ":MarkdownPreviewToggle<cr>", { desc = "Open Markdown Preview" } },

	{ "n", "<A-b>", ":Bracey<cr>", { desc = "Open Bracey" } },
	{ "n", "<A-B>", ":BraceyStop<cr>", { desc = "Stop Bracey" } },
	{ "i", "<A-b>", "<esc>:BraceyReload<cr>", { desc = "Reload Bracey" } },
	{ "n", "<A-r>", ":BraceyReload<cr>", { desc = "Reload Bracey" } },
	...
	-- cokeline
	{ "n", "<S-Tab>", "<Plug>(cokeline-focus-prev)", { desc = "Previous buffer", silent = true } },
	{ "n", "<Tab>", "<Plug>(cokeline-focus-next)", { desc = "Next buffer", silent = true } },
	{ "n", "<A-,>", "<Plug>(cokeline-switch-prev)", { desc = "Move buffer to left", silent = true } },
	{ "n", "<A-.>", "<Plug>(cokeline-switch-next)", { desc = "Move buffer to right", silent = true } },
